...
Software engineer with a love for building things that work well. I've been writing code since 2008, and I still genuinely enjoy it.
...
[![Website](https://img.shields.io/badge/Website-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white)](https://newt.fyi)
...
|---------------------------|------------------------------------------------------------------------------------------------|-----------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **CrashFlow**             | Personal finance tracking app                                                                  | React, Hono, PostgreSQL, TailwindCSS, Docker  | Currently in alpha <br/> ![Static Badge](https://img.shields.io/badge/Alpha-9810fa?style=flat&logo=vite&logoColor=white) - [Link](https://alpha.crashflow.org) <br /> ![Static Badge](https://img.shields.io/badge/Live-9810fa?style=flat&logo=vite&logoColor=white) - [Link](https://crashflow.org) |
| **Wishlist**              | Consolidated wishlist for sharing with friends - claim items to avoid duplicate gifts          | React, Hono, SQLite, TailwindCSS              | ![Static Badge](https://img.shields.io/badge/Live-9810fa?style=flat&logo=vite&logoColor=white) - [Live](https://cocox.dev)                                                                                                                                                                           |
| **Moonflower Ink Studio** | CRM-style website with admin panel for a friend's business                                     | React, Hono, SQLite, TailwindCSS, Docker      | ![Demo Site Under Development](https://img.shields.io/badge/demo-under_development-9810fa?style=for-the-badge)                                                                                                                                                                                       |
| **Artisan Storefront**    | E-commerce platform for handcrafted goods                                                      | Hono, React, TailwindCSS, PostgreSQL, Docker  | ![Site Under Development](https://img.shields.io/badge/site-under_development-9810fa?style=for-the-badge)                                                                                                                                                                                            |
...
I've moved my primary development to **Codeberg** because their values align with mine. I use GitHub and GitLab for fork development and contributions.

[![Codeberg](https://img.shields.io/badge/Codeberg-2185D0?style=for-the-badge&logo=codeberg&logoColor=white)](https://codeberg.org/coco32)

Most of my active projects are licensed under **GNU AGPL-3.0**.
